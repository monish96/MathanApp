...
var images = [
    ...
    require('../../assets/feed_images/3.jpeg'),
    require('../../assets/feed_images/4.jpeg'),
    require('../../assets/feed_images/5.jpeg'),
    require('../../assets/feed_images/6.jpeg'),
    require('../../assets/feed_images/7.jpeg'),
    require('../../assets/feed_images/8.jpeg'),
    require('../../assets/feed_images/9.jpeg'),
    require('../../assets/feed_images/10.jpeg'),
    require('../../assets/feed_images/11.jpeg'),
    require('../../assets/feed_images/12.jpeg'),
]
        ...
        if (this.state.activeIndex == 0) {
            ...
            return (
                <View>
                    ...
                    <CardComponent imageSource="2" likes="1041" />
                    <CardComponent imageSource="3" likes="12871" />
                </View>
            )
        }
    }
                    ...
                    <View style={{ paddingTop: 10 }}>
                        ...
                        <View style={{ paddingBottom: 10 }}>
                            <View style={{ paddingHorizontal: 10 }}>
                                <Text style={{ fontWeight: 'bold' }}>Praveen Mathan</Text>
                                <Text>Made for each other | Love Makes Life Beautiful | #Baby Shower</Text>
                                <Text>All are welcome to join us for baby shower</Text>
                            </View>
                        </View>
